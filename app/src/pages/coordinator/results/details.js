            ...
            <tr key={result._id} className="hover:bg-gray-100">
              ...
              <td className="py-2 px-4 border-b border-gray-200">
                {editedRowIndex === index ? (
                  <button
                    onClick={() =>
                      handleUpdateSubmit(result._id)
                    }
                    className="bg-green-500 hover:bg-green-700 text-white font-medium py-1 px-2 rounded-md"
                  >
                    Update
                  </button>
                ) : (
                  <button
                    onClick={() =>
                      handleEditClick(index, result)
                    }
                    className="bg-blue-500 hover:bg-blue-700 text-white font-medium py-1 px-2 rounded-md"
                  >
                    Edit
                  </button>
                )}
